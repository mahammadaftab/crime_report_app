...
import {
  DynamicEye as Eye,
  DynamicEyeOff as EyeOff,
  DynamicCalendar as Calendar,
  DynamicMail as Mail,
  DynamicUser as User,
  DynamicPhone as Phone,
  DynamicMapPin as MapPin,
  DynamicLock as Lock,
  DynamicSave as Save,
  DynamicX as X,
  DynamicStar as Star,
  DynamicAward as Award,
  DynamicFileText as FileText,
  DynamicTrophy as Trophy,
  DynamicPlusCircle as PlusCircle,
  DynamicMinusCircle as MinusCircle,
  DynamicGift as Gift,
  DynamicRefreshCw as RefreshCw,
  DynamicClock as Clock
...
export default function ProfilePage() {
  ...
  return (
    <PerformanceWrapper pageName="profile">
      <div className="min-h-screen bg-gradient-to-br from-black via-neutral-900 to-black py-12 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <motion.div
